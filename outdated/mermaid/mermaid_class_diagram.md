...
> Outdated reference only. This file is no longer maintained and may not match the current codebase. Use `UML Class Diagram/plantuml_class_diagram.puml` as the authoritative, up-to-date UML class diagram.
